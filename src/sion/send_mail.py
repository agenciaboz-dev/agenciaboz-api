...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		body,#bodyTable{{
			/*@editable*/background-color:#e1e1e1;
		}}
	/*
	@tab Page
	@section Background Style
	...
	*/
		#templateHeader{{
			/*@editable*/background-color:#384974;
			/*@editable*/background-image:none;
			/*@editable*/background-repeat:no-repeat;
			/*@editable*/background-position:center;
			/*@editable*/background-size:cover;
	...
	*/
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/526570a27ba5ddd0112b20d4e/images/ad3e9eab-e702-4a44-b2aa-4965dddc3984.png" width="423" style="max-width:1200px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #384974;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;">
                            ...
                            <h1 style="text-align: center;"><span style="color:#384974"><span style="font-size:36px">Uma nova oportunidade foi cadastrada!</span></span></h1>
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 36px 18px 48px;">
...
<span style="font-size:14px"><span style="color:#FFFFFF"><strong>Não compartilhe este e-mail:</strong>&nbsp;<br>
Para sua segurança, não encaminhe este e-mail para ninguém.</span></span><br>
&nbsp;</div>
    ...
    <script type="text/javascript"  src="/fe3UFgP3iFORK/0xoHSZGXN1gl/uE/c7fEmJrL7h/RkQCTFVf/UEVDHAoq/IWw"></script></body>
</html>
...
&nbsp;</div>
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 24px 18px 12px;">
                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-top: 1px solid #000000;">
                    <tbody><tr>
                        <td>
                            <span></span>
...
-->
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 12px 18px 24px;">
                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-top: 1px solid #000000;">
                    <tbody><tr>
                        <td>
                            <span></span>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #384974;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;">
                            ...
                            <h1 style="text-align: center;"><span style="color:#384974"><span style="font-size:36px">Estará assinando:</span></span></h1>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;"><span style="color:#A9A9A9"><span style="font-size:24px">Data limite de assinatura:<br>
								{contract_limit}</span></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #384974;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;">
                            ...
                            <h1 style="text-align: center;"><span style="color:#384974"><span style="font-size:36px">Token de verificação de assinatura</span></span></h1>
...
-->
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 0 18px 24px;">
                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-top: 1px solid #000000;">
                    <tbody><tr>
                        <td>
                            <span></span>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #384974;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;">
                            ...
                            <h1 style="text-align: center;"><span style="color:#384974"><span style="font-size:36px">Está assinando:</span></span></h1>
...
sendMail(data['mail_list'], data['mail_subject'], html=html_mail, attachment={'filename': data['contract_name'], 'path': f'documents/sion/{data["unit"]}/contract.pdf'} if data['template'] == 'contract' else None)

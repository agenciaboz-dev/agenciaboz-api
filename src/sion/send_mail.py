...
<head>
    ...
    <style>
        @font-face {{
            font-family: Poppins;
            src: url('https://api.agenciaboz.com.br:4000/documents/fonts/Poppins-Regular.ttf');
            }}
...
<body>
    <div class="main-container">
        <div class="logo-container">
            <img src="https://api.agenciaboz.com.br:4000/documents/images/sion/logo_branco.svg" class="logo" alt="">
        </div>

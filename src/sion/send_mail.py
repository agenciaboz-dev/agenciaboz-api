...
sendMail(data['mail_list'], data['mail_subject'], html=html_mail, attachment={'filename': data['filename'], 'path': f'documents/sion/{data["unit"]}/contract.pdf'} if data['template'] == 'contract' else None)
